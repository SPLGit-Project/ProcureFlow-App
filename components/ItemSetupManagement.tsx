...
const ItemSetupManagement = ({ options, items, upsertOption, deleteOption }: ItemSetupManagementProps) => {
    ...
    const [activeSection, setActiveSection] = useState<'TAXONOMY' | 'DROPDOWNS'>('TAXONOMY');
    ...
    const stats = useMemo(() => {
        ...
        return { savedTaxonomy, discoveredTaxonomy, savedDropdowns };
    }, [dropdownRows, taxonomyRows]);
                ...
                {[
                    ...
                    return (
                        <button
                            key={section.id}
                            type="button"
                            onClick={() => setActiveSection(section.id as 'TAXONOMY' | 'DROPDOWNS')}
