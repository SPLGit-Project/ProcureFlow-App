...
| `ACTIVE` | Record Delivery (Partial) | `ACTIVE` | Users with `receive_goods` |
| `ACTIVE` | Record Delivery (Full/Closed)| `RECEIVED` | Users with `receive_goods` |
| `ACTIVE` | Over-delivery or Short-close | `VARIANCE_PENDING` | System Logic (`addDelivery`) |
