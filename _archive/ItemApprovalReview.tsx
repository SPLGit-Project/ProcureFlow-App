      ...
      <div className="rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-[#1e2029] p-5">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap gap-2 items-center">
            <span className="text-xs font-bold rounded-full border border-[#129DC0]/20 bg-[#129DC0]/10 text-[#129DC0] dark:border-[#129DC0]/20 dark:bg-[#129DC0]/10 dark:text-[#129DC0] px-3 py-1">
        ...
        <SectionToggle title="Sell Pricing">
          ...
          <div className="mt-3">
            ...
            <div className="flex gap-2 flex-wrap">
              {sellDraft.publishToBundle && <span className="rounded-full bg-[#129DC0]/10 text-[#129DC0] dark:bg-[#129DC0]/10 dark:text-[#129DC0] px-2 py-0.5 text-xs font-bold">Bundle</span>}
          ...
          {latestDuplicate.candidates.slice(0, 3).map(c => (
            <div key={`${c.source}-${c.sourceId}`} className="py-2 border-b border-gray-100 dark:border-gray-800 last:border-0">
              <div className="flex items-center justify-between">
                ...
                <span className="text-xs font-black text-[#129DC0]">{(c.score * 100).toFixed(0)}%</span>
              </div>
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          {!showActions && (
            <button
              ...
              className="text-xs font-bold text-[#129DC0] hover:underline"
            >
              Record decision
            </button>
          )}
