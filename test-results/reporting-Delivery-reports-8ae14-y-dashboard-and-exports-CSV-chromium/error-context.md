...
- Name: reporting.spec.ts >> Delivery reports >> delivery variance shows exception-only dashboard and exports CSV
- Location: tests\e2e\reporting.spec.ts:53:5
...
Locator: getByTestId('variance-report-visual')
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for getByTestId('variance-report-visual')
      ...
      - generic [ref=e87]:
        - generic [ref=e88]:
          ...
          - generic [ref=e138]:
            ...
            - paragraph [ref=e140]: Exception-only view of pending, over-delivered, and short-closed delivery lines that need review.
        - generic [ref=e142]:
          - generic [ref=e143]:
            - generic [ref=e144]:
              - heading "Delivery Variance Analysis" [level=2] [ref=e145]
              - paragraph [ref=e146]:
                - img [ref=e147]
                - text: "Data updated at: 3:10:36 PM"
            - generic [ref=e150]:
